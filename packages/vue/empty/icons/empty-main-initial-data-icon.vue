...
/**
 * EmptyMainInitialDataIcon 的 SVG，逐節點移植自 React 版。
 *
 * 屬性名稱一律使用 DOM 的連字號形式（`stop-color`、`clip-path`）：JSX 會自動
 * 轉換 camelCase，Vue 不會，寫成 camelCase 瀏覽器會直接忽略。
 */
...
<template>
  ...
  >
    ...
    <g clip-path="url(#clip0_15033_10920)">
      <path
