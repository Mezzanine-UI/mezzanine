...
/**
 * What a single thumbnail card may be rendered as. React's list, with Vue's
 * `Component` standing in for `JSXElementConstructor`.
 */
export type SingleThumbnailCardComponent = 'a' | 'div' | Component;

/**
 * SingleThumbnailCard type discriminator
 */
export type SingleThumbnailCardType = 'action' | 'default' | 'overflow';
 ...
 * an attribute.
 */
export interface SingleThumbnailCardProps {
  /**
