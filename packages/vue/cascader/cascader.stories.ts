...
export default {
  ...
  component: MznCascader,
} satisfies Meta<typeof MznCascader>;
...
const STORY_COMPONENTS = { MznCascader, MznTypography, TextParts };

type Story = StoryObj<typeof MznCascader>;
...
export const Playground: Story = {
  ...
  render: (args) => ({
    ...
    setup: () => {
      const value = ref<CascaderOption[]>([]);

      return { args, taiwanOptions, value };
    },
    template: `
...
export const Basic: Story = {
  render: () => ({
    ...
    setup: () => {
      ...
      return { taiwanOptions, value };
    },
    template: `
      <div style="display: flex; flex-direction: column; gap: 24px; max-width: 400px">
        <div>
          <MznTypography variant="body" style="margin-bottom: 8px">
            三層選項（國家 / 城市 / 區域）
          </MznTypography>
          <MznCascader
            fullWidth
        ...
        >
          <MznTypography variant="body" style="margin-bottom: 4px">
            已選取：
          </MznTypography>
...
export const States: Story = {
  render: () => ({
    components: STORY_COMPONENTS,
    setup: () => ({ preselectedValue, taiwanOptions }),
    template: `
      <div
        style="display: grid; grid-template-columns: repeat(2, 280px); gap: 24px; align-items: start"
      >
        <div>
          <MznTypography variant="body" style="margin-bottom: 8px">
            預設（Default）
      ...
      <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
        ...
        <div style="padding: 12px; background-color: #f5f5f5; border-radius: 4px">
          ...
          <template v-if="value.length > 0">
            ...
            >
              <TextParts
                :parts="['[', i, '] id: ', v.id, ' / name: ', v.name]"
              />
            </MznTypography>
          </template>
          <MznTypography v-else variant="body" style="font-size: 12px; color: #999">
            尚未選取
          </MznTypography>
        </div>
        <button
...
export const WithDisabledOptions: Story = {
  render: () => ({
    ...
    setup: () => {
      ...
      return { optionsWithDisabled, value };
    },
    template: `
      <div style="max-width: 320px">
        <MznTypography variant="body" style="margin-bottom: 8px">
  ...
  render: () => ({
    ...
    template: `
      <div style="max-width: 320px">
        <MznTypography variant="body" style="margin-bottom: 8px">
          <TextParts
            :parts="['設定 menuMaxHeight=', 200, '，選項超出時可捲動']"
          />
        </MznTypography>
        <MznCascader
          fullWidth
...
export const InForm: Story = {
  render: () => ({
    ...
    template: `
      <div
        style="display: flex; flex-direction: column; gap: 16px; max-width: 400px; padding: 24px; border: 1px solid #e0e0e0; border-radius: 8px"
      >
        <MznTypography variant="h3">商品資料</MznTypography>
        <div>
          <MznTypography variant="body" style="margin-bottom: 4px">
            倉庫地區：
          </MznTypography>
...
export const MixedDepth: Story = {
  render: () => ({
    ...
    setup: () => {
      ...
      return { mixedDepthOptions, value };
    },
    template: `
      <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
        <MznTypography variant="body" style="margin-bottom: 4px">
        ...
        <div>
          ...
          <div style="width: 160px">
            <MznCascader
              ...
              :options="taiwanOptions"
              placeholder="國家 / 城市 / 區域"
              :defaultValue="preselectedOverflowValue"
            />
          </div>
        </div>
        <div>
