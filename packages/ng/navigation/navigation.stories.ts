  ...
  render: () => ({
    ...
    template: `
      <div style="height: calc(100vh - 32px); display: grid;">
        <mzn-navigation>
          <mzn-navigation-header title="Mezzanine">
          ...
          <mzn-navigation-option title="訂單管理" [icon]="ListIcon" [hasChildren]="true">
            <mzn-navigation-option title="待處理訂單" />
            <mzn-navigation-option title="已完成訂單" />
          </mzn-navigation-option>
          <mzn-navigation-option title="會員管理" href="/members" [icon]="UserIcon" />
          @for (i of items; track i) {
            <mzn-navigation-option [title]="'專案 ' + i" [icon]="FolderIcon" [hasChildren]="true">
              <mzn-navigation-option [title]="'專案設定 ' + i" />
              <mzn-navigation-option [title]="'成員管理 ' + i" />
            </mzn-navigation-option>
          }
          <mzn-navigation-footer>
            <span>王小明</span>
            <mzn-navigation-icon-button [icon]="QuestionOutlineIcon" />
          </mzn-navigation-footer>
        </mzn-navigation>
      </div>
    `,
    ...
    template: `
      <div style="height: calc(100vh - 32px); display: grid;">
        <mzn-navigation>
          ...
          <mzn-navigation-option title="首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁首頁" />
          <mzn-navigation-option title="數據分析" [hasChildren]="true">
            <mzn-navigation-option title="流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表流量報表" />
            <mzn-navigation-option title="轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析轉換率分析" />
          </mzn-navigation-option>
          @for (i of items; track i) {
  ...
  template: `
    <div style="display: flex; gap: 48px; height: calc(100vh - 32px);">
      <mzn-navigation
        ...
        (optionClick)="activatedPath.set($event)"
      >
        <mzn-navigation-header title="企業管理平台">
          <span
            aria-label="logo"
            style="background-color: #5D74E9; border-radius: 4px; height: 28px; width: 28px; display: block;"
          ></span>
        ...
        <mzn-navigation-option-category title="主要功能">
          <mzn-navigation-option title="儀表板" />
          <mzn-navigation-option title="數據分析" [hasChildren]="true">
            <mzn-navigation-option title="銷售報表" href="/iframe.html" />
            <mzn-navigation-option title="流量分析" />
            <mzn-navigation-option title="用戶行為" />
          </mzn-navigation-option>
          <mzn-navigation-option title="訂單管理" [hasChildren]="true">
            <mzn-navigation-option title="全部訂單" />
            <mzn-navigation-option title="待出貨" />
            <mzn-navigation-option title="退換貨處理" />
          </mzn-navigation-option>
        ...
        <mzn-navigation-option-category title="內容管理">
          <mzn-navigation-option title="文章管理" [hasChildren]="true">
            <mzn-navigation-option title="文章列表" [hasChildren]="true">
              <mzn-navigation-option title="已發布" />
              <mzn-navigation-option title="草稿" />
            </mzn-navigation-option>
            <mzn-navigation-option title="分類設定" />
          </mzn-navigation-option>
          <mzn-navigation-option title="媒體庫" [hasChildren]="true">
            <mzn-navigation-option title="圖片" />
            <mzn-navigation-option title="影片" />
            <mzn-navigation-option title="文件" />
          </mzn-navigation-option>
        </mzn-navigation-option-category>
        <mzn-navigation-option-category title="系統設定">
          <mzn-navigation-option title="用戶管理" [hasChildren]="true">
            <mzn-navigation-option title="用戶列表" [hasChildren]="true">
              <mzn-navigation-option title="活躍用戶" />
              <mzn-navigation-option title="停用帳號" />
            </mzn-navigation-option>
            <mzn-navigation-option title="角色權限" />
          </mzn-navigation-option>
          <mzn-navigation-option title="系統設定" [hasChildren]="true">
            <mzn-navigation-option title="基本設定" [hasChildren]="true">
              <mzn-navigation-option title="網站資訊" />
              <mzn-navigation-option title="SEO 設定" />
            </mzn-navigation-option>
            <mzn-navigation-option title="安全性設定" />
          </mzn-navigation-option>
          <mzn-navigation-option title="下載中心" href="#download-center" />
        </mzn-navigation-option-category>
        <mzn-navigation-footer>
          <span>李經理</span>
