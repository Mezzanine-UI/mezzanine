...
import { forwardRef, useRef, useState, KeyboardEvent, ClipboardEvent, ChangeEvent } from 'react';
 ...
 */
const ModalBodyForVerification = forwardRef<HTMLDivElement, ModalBodyForVerificationProps>(
