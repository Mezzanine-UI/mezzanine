...
const UploadPicture = forwardRef<HTMLDivElement, UploadPictureProps>(
  function UploadPicture(props, ref) {
    const {
      accept = 'image/*',
      className,
      controllerRef,
        ...
        if (files.length) {
          ...
          if (onUpload) {
            const setProgress = (progress: number) =>
              uploadPictureImageLoader.current.setPercentage(progress);
