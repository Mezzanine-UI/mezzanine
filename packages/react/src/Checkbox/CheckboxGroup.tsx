...
export interface CheckboxGroupProps
  extends Omit<InputCheckGroupProps, 'defaultValue' | 'onChange'> {
  /**
...
const renderOption = ({ label: children, ...option }: CheckboxGroupOption) => (
  <Checkbox {...option} key={option.value}>
    {children}
  </Checkbox>
);
