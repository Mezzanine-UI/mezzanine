...
import { useTableV2SuperContext } from '../TableV2Context';
...
export interface UseTableV2FixedOffsetsReturn {
...
export interface UseTableV2FixedOffsetsOptions {
  /** Column definitions */
...
export function useTableV2FixedOffsets(
  options: UseTableV2FixedOffsetsOptions,
): UseTableV2FixedOffsetsReturn {
  const { expansionLeftPadding = 0 } = useTableV2SuperContext();
