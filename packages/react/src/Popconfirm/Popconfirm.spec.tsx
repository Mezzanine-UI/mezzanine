...
describe('<Popconfirm />', () => {
  ...
  describeForwardRefToHTMLElement(HTMLDivElement, (ref) =>
    render(<Popconfirm ref={ref} open />),
  );

  it('should bind host class', async () => {
    await act(async () => {
      await render(<Popconfirm anchor={document.body} open />);
    });
  ...
  describe('prop: icon', () => {
    it('should render the popconfirm icon and bind icon class', async () => {
      await act(async () => {
        await render(
          <Popconfirm anchor={document.body} icon={PlusIcon} open />,
        );
      });
      ...
      expect(
        iconElement!.classList.contains('mzn-popconfirm__icon'),
      ).toBeTruthy();
    });
  });
  ...
  describe('prop: title', () => {
    it('should render the popconfirm title', async () => {
      await act(async () => {
        await render(<Popconfirm anchor={document.body} title="title" open />);
      });
