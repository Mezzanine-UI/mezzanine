...
| P2-6     | _(pending)_ | input-action-button, input-select-button, input-spinner-button, input-check, input-trigger-popper, select, select-trigger, select-trigger-tags | —            | per-comp    | input internals + select family; 5 fall back to div (Angular-only or missing React file)                                                                                                                                                                                                   |
