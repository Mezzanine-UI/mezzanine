...
| P2-7     | _(pending)_ | dropdown(+item/item-card/action), pagination(+item/jumper/page-size)                                                                           | —            | per-comp    | pagination host auto-detected as `<nav>` via JSX root; dropdown-\* sub-components fall back to div (Angular-only)                                                                                                                                                                          |
